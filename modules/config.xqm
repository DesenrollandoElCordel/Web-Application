...
declare variable $config:facets := [
    ...
    map {
        "dimension": "atuendo",
        "heading": "facets.atuendo",
        "max": 3,
        "hierarchical": false()
    },
    map {
        "dimension": "actitud",
        "heading": "facets.actitud",
        "max": 3,
        "hierarchical": false()
    },
    map {
        "dimension": "instrumento",
        "heading": "facets.instrumento",
        "max": 3,
        "hierarchical": false()
    },
    map {
        "dimension": "blanca",
        "heading": "facets.blanca",
        "max": 3,
        "hierarchical": false()
    },
    map {
        "dimension": "fuego",
        "heading": "facets.fuego",
        "max": 3,
        "hierarchical": false()
    },
    map {
...
(:~
 ...
 :)
declare variable $config:odd-available :=("projet_cordel.odd");
